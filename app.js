...
questScenes = [
  {
    ...
    "photo": "img/1Генерал-лейтенант Кисунько Г.В.jpg",
...
const galleryImages = [
    { src: 'img/2а Юный Григорий Кисунько.jpg', caption: 'Юный Григорий Кисунько' },
    { src: 'img/2Отчий дом.jpg', caption: 'Отчий дом' },
    { src: 'img/3Ворошиловградский пединститут.jpg', caption: 'Ворошиловградский пединститут' },
    { src: 'img/4Кисунько Г.В. - аспирант.jpg', caption: 'Г.В. Кисунько — аспирант' },
    { src: 'img/5Кисунько Г.В. - рядовой ополчения.jpg', caption: 'Г.В. Кисунько — рядовой ополчения' },
    { src: 'img/6Кисунько Г.В.- курсант ВНОС.jpg', caption: 'Г.В. Кисунько — курсант ВНОС' },
    { src: 'img/7Кисунько Г.В. - командир взвода.jpg', caption: 'Г.В. Кисунько — командир взвода' },
    { src: 'img/8Военная академия связи им. С.М. Буденного.jpg', caption: 'Военная академия связи им. С.М. Будённого' },
    { src: 'img/9Кисунько Г.В. - КБ-1.webp', caption: 'Г.В. Кисунько — КБ‑1' },
    { src: 'img/10Система С-25 С ЗРК Беркут.jpg', caption: 'Система С‑25 (ЗРК «Беркут»)' },
    { src: 'img/12Система А - экспериментальный комплекс.jpg', caption: 'Система «А» — экспериментальный комплекс' },
    { src: 'img/13Пуск противоракеты.jpg', caption: 'Пуск противоракеты' },
    { src: 'img/14музейный экспонат - памятник создателям ПРО.jpg', caption: 'Музейный экспонат — памятник создателям ПРО' },
    { src: 'img/11Золотая медаль «Серп и Молот» Героя Социалистического Труда.jpg', caption: 'Золотая медаль «Серп и Молот»' },
    { src: 'img/15Медаль Лауреата Ленинской премии.png', caption: 'Медаль лауреата Ленинской премии' },
    { src: 'img/1Генерал-лейтенант Кисунько Г.В.jpg', caption: 'Генерал-лейтенант Г.В. Кисунько' },
    { src: 'img/15Кисунько Г.В. (1918-1998).jpg', caption: 'Г.В. Кисунько (1918–1998)' },
];
