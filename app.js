...
questScenes = [
  ...
  },
  {
    ...
    "photo": "img/kisunko_school.jpg",
    "photoCaption": "Фото: Юный Григорий Кисунько",
    "next": 3,
    "year": 1918,
  ...
  {
    "id": 3,
    "title": "СЦЕНА 3: УЧЁБА В ЛУГАНСКОМ ПЕДИНСТИТУТЕ",
    "dialog": [
      {
        "speaker": "archive",
        "text": "Сначала Григорий обучается на физико-математическом факультете Луганского педагогического института, который заканчивает в 1938 году с отличием."
      },
      {
        "speaker": "student",
    ...
    "photo": "img/kisunko_student.jpg",
    "photoCaption": "Фото: Студент Луганского пединститута",
    "next": 4,
    "year": 1938,
    "place": "Луганск",
    "glossaryUnlock": [],
  ...
  },
  {
    ...
    "photo": "img/herzen_university.jpg",
    "photoCaption": "РГПУ им. А. И. Герцена (Ленинград), где Кисунько учился в аспирантуре",
    "next": 5,
    "year": 1941,
    "place": "Ленинград",
    "glossaryUnlock": [],
  ...
  },
  {
    ...
    "dialog": [
      ...
      {
        "speaker": "student",
        "text": "Учёный и сразу рядовым на фронт?"
      },
      {
        "speaker": "archive",
    ...
    "photo": "img/kisunko_soldier.jpg",
    "photoCaption": "Фото: Рядовой ополчения, 1941",
    "next": 6,
    "year": 1941,
    "place": "Ленинград",
    "glossaryUnlock": [],
  ...
  },
  {
    ...
    "dialog": [
      ...
      {
        "speaker": "archive",
        "text": "Февраль 1942 года. Там он учится ловить вражеские самолеты радиолокатором."
      },
      {
        "speaker": "student",
    ...
    "photo": "img/rus1_radar.jpg",
    "photoCaption": "РЛС РУС‑1 «Ревень» — пример техники ВНОС и ранней радиолокации",
    "next": 7,
    "year": 1942,
    "place": "Училище ВНОС",
    "glossaryUnlock": [
  ...
  },
  {
    ...
    "photo": "img/leningrad_aa.jpg",
    "photoCaption": "«Зенитчики на страже Ленинградского неба», 1941",
    "next": 8,
    "year": 1942,
    "place": "Москва (ПВО)",
    "glossaryUnlock": [
    ...
    "sources": [
      {
        "title": "Википедия: Противовоздушная оборона",
        "url": "https://ru.wikipedia.org/wiki/Противовоздушная_оборона"
      },
      {
        "title": "Википедия: Радиолокация",
        "url": "https://ru.wikipedia.org/wiki/Радиолокация"
  ...
  },
  {
    ...
    "photo": "img/budyonny_academy.jpg",
    "photoCaption": "Военная академия связи им. С. М. Будённого (Санкт‑Петербург)",
    "next": 9,
    "year": 1944,
    "place": "Ленинград",
    "glossaryUnlock": [],
  ...
  },
  {
    ...
    "photo": "img/almaz_hq.jpg",
    "photoCaption": "Штаб‑квартира НПО «Алмаз» / «Алмаз‑Антей» (Москва)",
    "next": 10,
    "year": 1950,
    ...
    "sources": [
      {
        "title": "Википедия: КБ-1 (СССР)",
        "url": "https://ru.wikipedia.org/wiki/КБ-1"
      },
      {
  ...
  },
  {
    ...
    "photo": "img/rocket.jpg",
    "photoCaption": "Зенитная ракета (иллюстрация темы ПВО)",
    "choices": [
      {
    ...
    "sources": [
      {
        "title": "Википедия: С-25",
        "url": "https://ru.wikipedia.org/wiki/С-25"
      },
      {
  ...
  },
  {
    ...
    "photo": "img/hero_medal.png",
    "photoCaption": "Медаль «Серп и Молот» — Герой Социалистического Труда",
    "next": 12,
    "year": 1956,
    "place": "СССР",
    "glossaryUnlock": [
  ...
  },
  {
    ...
    "sources": [
      {
        "title": "Википедия: Система А",
        "url": "https://ru.wikipedia.org/wiki/Система_А"
      },
      {
  ...
  },
  {
    ...
    "dialog": [
      {
        "speaker": "archive",
        "text": "4 марта 1961 года. Полигон Сары‑Шаган, озеро Балхаш."
      },
      {
        "speaker": "archive",
        "text": "Советская ракета‑перехватчик впервые в мире сбивает баллистическую ракету на встречном курсе."
      },
      {
        "speaker": "student",
        "text": "То самое ‘попали в муху в космосе’?"
      },
      {
        "speaker": "archive",
        "text": "Именно. Этот запуск навсегда вошёл в историю мировой противоракетной обороны."
      }
    ],
    "buttonText": "Финал?",
    "photo": "img/rocket_launch.jpg",
    "photoCaption": "Фото: Пуск ракеты на полигоне Сары‑Шаган",
    "next": 14,
    "year": 1961,
    "place": "Сары‑Шаган",
    "glossaryUnlock": [
    ...
    "sources": [
      {
        "title": "Википедия: Сары-Шаган (полигон)",
        "url": "https://ru.wikipedia.org/wiki/Сары-Шаган_(полигон)"
      },
      {
  ...
  },
  {
    ...
    "photo": "img/don2n_radar.jpg",
    "photoCaption": "Радар Дон‑2Н — ключевой элемент современной системы ПРО Москвы",
    "next": null,
    "year": 1972,
    "place": "Москва (ПРО)",
    "glossaryUnlock": [
    ...
    "sources": [
      {
        "title": "Википедия: А-35",
        "url": "https://ru.wikipedia.org/wiki/А-35"
      },
      {
        "title": "Википедия: А-135",
        "url": "https://ru.wikipedia.org/wiki/А-135"
      },
      {
...
const DEFAULT_HISTORICAL_FACTS = [
    { id: 'intercept-1961', title: 'ФАКТ: ПЕРВЫЙ ПЕРЕХВАТ', content: '4 марта 1961 года на полигоне Сары‑Шаган экспериментальный комплекс ПРО «Система А» впервые в мире перехватил боеголовку баллистической ракеты (цель Р‑12) противоракетой В‑1000.' },
    { id: 'system-a-1956', title: 'ФАКТ: СТАРТ ПРОЕКТА «А»', content: 'Работы по системе «А» развернулись в середине 1950‑х на полигоне Сары‑Шаган: это был первый советский экспериментальный комплекс стратегической ПРО.' },
    ...
    { id: 'saryshagan-scale', title: 'ФАКТ: МАСШТАБЫ ПОЛИГОНА', content: 'Испытательный район Сары‑Шаган занимал десятки тысяч квадратных километров (порядка 81 тыс. км²) и включал большую трассу полёта целей и противоракет.' },
    ...
    { id: 'dunay2-1958', title: 'ФАКТ: РЛС «ДУНАЙ‑2»', content: 'РЛС дальнего обнаружения «Дунай‑2» была ключевым элементом системы «А». Уже 6 августа 1958 года она впервые обнаружила в полёте баллистическую ракету Р‑5 на расстоянии около 1000 км.' },
    { id: 'dunay2-1500', title: 'ФАКТ: ДАЛЬНОСТЬ ОБНАРУЖЕНИЯ', content: 'На испытаниях 4 марта 1961 года «Дунай‑2» обнаружил ракету Р‑12 на дальности до 1500 км — это давало системе время на расчёт перехвата.' },
    ...
    { id: 'v1000-missile', title: 'ФАКТ: ПРОТИВОРАКЕТА В‑1000', content: 'В‑1000 — противоракета, которую использовали в испытаниях системы «А». Именно она применялась в перехвате 4 марта 1961 года.' },
    { id: 'system-a-experimental', title: 'ФАКТ: «А» БЫЛА ЭКСПЕРИМЕНТАЛЬНОЙ', content: 'Система «А» не стала боевой: её задача — отработать принципы обнаружения, сопровождения и наведения. Но именно этот опыт лег в основу последующих систем ПРО.' },
    { id: 'abm-treaty-1972', title: 'ФАКТ: ДОГОВОР ПО ПРО (1972)', content: 'Договор об ограничении систем ПРО (ABM Treaty) подписан в Москве 26 мая 1972 года и ограничивал развёртывание противоракетных систем у сторон.' },
    { id: 'abm-protocol-1974', title: 'ФАКТ: ПРОТОКОЛ 1974 ГОДА', content: 'В 1974 году к договору по ПРО был подписан протокол: он сократил разрешённое число районов развёртывания ПРО до одного у каждой стороны.' },
    { id: 'a35-1972', title: 'ФАКТ: А‑35 — ПРО МОСКВЫ', content: 'А‑35 — советская система ПРО, развернутая вокруг Москвы. Она начала нести боевое дежурство в июне 1972 года и стала единственной системой ПРО СССР, допустимой по договору 1972 года.' },
    { id: 'a35-a350', title: 'ФАКТ: ПРОТИВОРАКЕТЫ А‑350', content: 'В составе А‑35 использовались противоракеты А‑350 с ядерным боезарядом (перехват вне атмосферы).' },
    { id: 'a135-1995', title: 'ФАКТ: А‑135 — ПРЕЕМНИК А‑35', content: 'Система А‑135 стала развитием московской ПРО и официально вошла в строй в 1990‑е годы; в справочниках часто указывают 1995 год как начало службы.' },
    { id: 'don2n-role', title: 'ФАКТ: РАДАР DON‑2N', content: 'Многофункциональный радар Don‑2N — ключевой элемент А‑135: он обеспечивает круговой обзор 360° и сопровождение целей для наведения противоракет.' },
    { id: 'don2n-location', title: 'ФАКТ: ГДЕ НАХОДИТСЯ DON‑2N', content: 'Don‑2N расположен в Московской области, в районе Софрино (Пушкинский район) — рядом с основными объектами московской ПРО.' },
    { id: 'don2n-timeline', title: 'ФАКТ: СТРОИТЕЛЬСТВО DON‑2N', content: 'Строительство Don‑2N началось в 1978 году; станцию вводили поэтапно, а полноценную эксплуатацию относят к 1990‑м (в источниках встречается 1996 год).' },
    { id: 'kisunko-chiefdesigner', title: 'ФАКТ: КИСУНЬКО — ГЛАВКОНСТРУКТОР', content: 'Г.В. Кисунько был главным конструктором системы «А» (с 1956 года) и затем руководил созданием московской системы ПРО А‑35.' },
    { id: 'lenin-prize-1966', title: 'ФАКТ: ЛЕНИНСКАЯ ПРЕМИЯ (1966)', content: 'В 1966 году Г.В. Кисунько и коллектив разработчиков получили Ленинскую премию за создание системы «А» и связанные исследования.' },
    { id: 'hero-1956', title: 'ФАКТ: ГЕРОЙ СОЦИАЛИСТИЧЕСКОГО ТРУДА', content: 'В 1956 году Кисунько получил звание Героя Социалистического Труда за участие в создании московской системы ПВО С‑25 («Беркут»).' },
    { id: 'secret-zone-book', title: 'ФАКТ: «СЕКРЕТНАЯ ЗОНА»', content: 'В 1996 году Кисунько издал воспоминания «Секретная зона» — одну из самых известных книг о становлении советской ПРО.' },
    ...
    { id: 'nuclear-tests-1961-62', title: 'ФАКТ: ВЫСОТНЫЕ ИСПЫТАНИЯ 1961–1962', content: 'В 1961–1962 годах над районом Сары‑Шагана проводились высоковысотные ядерные испытания серии «К» (взрывы на высотах десятки и сотни километров).' },
    ...
    { id: 'abm-withdrawal-2002', title: 'ФАКТ: КОНЕЦ ДОГОВОРА ПО ПРО', content: 'США вышли из договора по ПРО: уведомление было дано в декабре 2001 года, а выход вступил в силу 13 июня 2002 года.' },
    { id: 'saryshagan-active-2022', title: 'ФАКТ: ПОЛИГОН ДЕЙСТВУЕТ', content: 'Сары‑Шаган остаётся действующим испытательным полигоном: в открытых источниках упоминаются пуски и в 2020‑е годы.' }
];
...
const galleryImages = [
    { src: 'img/kisunko_teacher.jpg', caption: 'Г.В. Кисунько' },
    { src: 'img/kisunko_school.jpg', caption: 'Юный Григорий' },
    { src: 'img/kisunko_student.jpg', caption: 'Студент' },
    { src: 'img/herzen_university.jpg', caption: 'РГПУ им. А. И. Герцена' },
    { src: 'img/kisunko_soldier.jpg', caption: 'На фронте' },
    { src: 'img/rus1_radar.jpg', caption: 'РЛС РУС‑1 «Ревень»' },
    { src: 'img/leningrad_aa.jpg', caption: 'ПВО. Ленинград, 1941' },
    { src: 'img/budyonny_academy.jpg', caption: 'Академия связи им. Будённого' },
    { src: 'img/almaz_hq.jpg', caption: 'КБ‑1 / НПО «Алмаз» (Москва)' },
    { src: 'img/rocket.jpg', caption: 'Зенитная ракета' },
    { src: 'img/hero_medal.png', caption: 'Герой Соцтруда' },
    { src: 'img/system_A.jpg', caption: 'Система “А”' },
    { src: 'img/rocket_launch.jpg', caption: 'Испытания. Пуск' },
    { src: 'img/don2n_radar.jpg', caption: 'Радар Дон‑2Н' }
];
