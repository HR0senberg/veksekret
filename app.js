...
const finalScreen = {
    ...
    photo: 'img/g17_kisunko_1918_1998.jpg',
    photoCaption: 'Фото: Г.В. Кисунько (1918–1998)'
};
...
questScenes = [
    ...
    ]},
  {
    ...
    "photo": "img/g02_home.jpg",
    "photoCaption": "Фото: Дом Григория Кисунько",
    "next": 3,
    "year": 1918,
    ...
    ]},
  {
    ...
    "photo": "img/g05_militia.jpg",
    "photoCaption": "Фото:Кисунько Г.В. - рядовой ополчения, 1941",
    "next": 6,
    "year": 1941,
    "place": "Ленинград",
    "glossaryUnlock": [],
    ...
    ]},
  {
    ...
    "photo": "img/g13_memorial_pro.jpg",
...
const DEFAULT_HISTORICAL_FACTS = [
    ...
    { id: 'system-a-1956', title: 'ФАКТ: СТАРТ ПРОЕКТА «А»', content: 'Работы по Системе «А» развернулись во второй половине XX века на полигоне СарыШаган. Это был первый советский экспериментальный комплекс стратегической ПРО' },
    ...
    { id: 'dunay2-1958', title: 'ФАКТ: РЛС «ДУНАЙ‑2»', content: 'РЛС дальнего обнаружения «Дунай2» была ключевым элементом системы «А». Уже 6 августа 1958 года она впервые обнаружила в полёте баллистическую ракету Р5 на расстоянии около 25 км.' },
    { id: 'dunay2-1500', title: 'ФАКТ: ДАЛЬНОСТЬ ОБНАРУЖЕНИЯ', content: '4 марта 1961 года РЛС «Дунай2» обнаружила ракету Р12 на дальности до 1000 км (это давало системе время на расчёт перехвата), сбила на дальности 78 км и высоте 23 км.' },
    { id: 'm40-computer', title: 'ФАКТ: ЭВМ М‑40 — «МОЗГ» ПЕРЕХВАТА', content: 'Наведение в Системе «А» считала управляющая ЭВМ М40, она управляла РЛС сопровождения и выдавалa команды на противоракету. В марте 1961 М40 участвовала в испытании с уничтожением боеголовки.' },
    { id: 'm40-real-time', title: 'ФАКТ: КОМПЬЮТЕР РЕАЛЬНОГО ВРЕМЕНИ', content: '«М40» создавали специально для задач ПРО. Это был один из ранних примеров вычислительной системы реального времени для управления сложным объектом.' },
    ...
    { id: 'a35-1972', title: 'ФАКТ: СИСТЕМА «А35» — ПРО МОСКВЫ', content: 'Система «А35» - советская система ПРО, развернутая вокруг Москвы. Она была поставлена на боевое дежурство в 1977 году, и столица нашей Родины обрела надежную защиту.' },
    { id: 'a35-a350', title: 'ФАКТ: ПРОТИВОРАКЕТЫ «А‑350»', content: 'В составе Системы «А35» использовались противоракеты «А350» с ядерным боезарядом (перехват вне атмосферы)' },
    { id: 'a135-1995', title: 'ФАКТ: СИСТЕМЫ «А135» — ПРЕЕМНИК  «А35»', content: 'Система «А135» - система противоракетной обороны (защиты) города Москвы. Она была принята на вооружение в 1996 году.' },
    ...
    { id: 'don2n-location', title: 'ФАКТ: ГДЕ НАХОДИТСЯ «ДОН 2-Н»', content: '«ДОН 2-Н» расположен в районе Софрино Московской области, рядом с основными объектами московской ПРО.' },
    ...
    { id: 'kisunko-chiefdesigner', title: 'ФАКТ: КИСУНЬКО — ГЕНЕРАЛЬНЫЙ КОНСТРУКТОР', content: 'Г.В. Кисунько был генеральным конструктором Системы «А» (с 1956 года), а затем руководил созданием московской ПРО Системы «А35».' },
    ...
    { id: 'nuclear-tests-1961-62', title: 'ФАКТ: ВЫСОТНЫЕ ИСПЫТАНИЯ 1961–1962', content: 'В 1961–1962 годах в районе полигона СарыШаган проводились высоковысотные ядерные испытания серии «К» (взрывы на высотах десятки и сотни километров).' },
    { id: 'site-awards', title: 'ФАКТ: НАГРАДЫ ПОЛИГОНА', content: 'За вклад в разработку новой техники полигон СарыШаган был награждён орденом Ленина (1966) и орденом Красной Звезды (1981).' },
...
const galleryImages = [
    { src: 'img/g01_young.jpg', caption: 'Юный Григорий Кисунько' },
    { src: 'img/g02_home.jpg', caption: 'Отчий дом' },
    { src: 'img/g03_pedinstitut.jpg', caption: 'Ворошиловградский пединститут' },
    { src: 'img/g04_aspirant.jpg', caption: 'Г.В. Кисунько — аспирант' },
    { src: 'img/g05_militia.jpg', caption: 'Г.В. Кисунько — рядовой ополчения' },
    { src: 'img/g06_vnos.jpg', caption: 'Г.В. Кисунько — курсант ВНОС' },
    { src: 'img/g07_commander.jpg', caption: 'Г.В. Кисунько — командир взвода' },
    { src: 'img/g08_academy.jpg', caption: 'Военная академия связи им. С.М. Будённого' },
    { src: 'img/g09_kb1.webp', caption: 'Г.В. Кисунько — КБ‑1' },
    { src: 'img/g10_s25.jpg', caption: 'Система С‑25 (ЗРК «Беркут»)' },
    { src: 'img/g11_system_a.jpg', caption: 'Система «А» — экспериментальный комплекс' },
    { src: 'img/g12_missile_launch.jpg', caption: 'Пуск противоракеты' },
    { src: 'img/g13_memorial_pro.jpg', caption: 'Музейный экспонат — памятник создателям ПРО' },
    { src: 'img/g14_serp_molot.jpg', caption: 'Золотая медаль «Серп и Молот»' },
    { src: 'img/g15_lenin_prize.png', caption: 'Медаль лауреата Ленинской премии' },
    { src: 'img/g16_general.jpg', caption: 'Генерал-лейтенант Г.В. Кисунько' },
    { src: 'img/g17_kisunko_1918_1998.jpg', caption: 'Г.В. Кисунько (1918–1998)' },
];
